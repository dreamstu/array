define("array/1.0.0/index-debug", [], function(require, exports, module) {
   ...
   */
  array.indexOf = Array.prototype.indexOf ? function() {
   ...
   */
  array.lastIndexOf = Array.prototype.lastIndexOf ? function() {
    var args = Array.prototype.slice.call(arguments, 1);
   ...
   *
   */
  array.forEach = Array.prototype.forEach ? function() {
    var args = Array.prototype.slice.call(arguments, 1);
   ...
   */
  array.filter = Array.prototype.filter ? function() {
    var args = Array.prototype.slice.call(arguments, 1);
   ...
   * @return {Boolean}
   */
  array.some = Array.prototype.some ? function() {
    var args = Array.prototype.slice.call(arguments, 1);
   ...
   */
  array.map = Array.prototype.map ? function() {
    var args = Array.prototype.slice.call(arguments, 1);
   ...
   * @return {Boolean}
   */
  array.reduce = Array.prototype.reduce ? function() {
    var args = Array.prototype.slice.call(arguments, 1);
   ...
   * @return {Boolean}
   */
  array.reduceRight = Array.prototype.reduceRight ? function() {
    var args = Array.prototype.slice.call(arguments, 1);
